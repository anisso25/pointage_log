...
<body>
    <div class="container">
        ...
        <form action="export-old.php" method="POST">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($result->num_rows > 0) {
                ...
                $headers = array("ID", "Nom utilisateur", "Date", "Heure début", "Heure fin", "Durée");
                ...
                echo '<table>';
                echo '<tr><th>ID</th><th>Nom utilisateur</th><th>Date</th><th>Heure début</th><th>Heure fin</th><th>Durée</th></tr>';
